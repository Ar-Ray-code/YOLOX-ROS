...
def generate_launch_description():
    launch_args = [
        ...
        DeclareLaunchArgument("p6", default_value="false", description="with p6."),
        DeclareLaunchArgument(
            "class_labels_path",
            default_value="",
        ...
        DeclareLaunchArgument(
            "num_classes", default_value="80", description="num classes."
        ),
        DeclareLaunchArgument(
            "model_version",
        ...
        DeclareLaunchArgument("onnxruntime_inter_op_num_threads", default_value="1"),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            "conf", default_value="0.30", description="yolox confidence threshold."
        ),
        DeclareLaunchArgument(
            "nms", default_value="0.45", description="yolox nms threshold"
        ),
        DeclareLaunchArgument("imshow_isshow", default_value="true", description=""),
        DeclareLaunchArgument(
                ...
                parameters=[
                    {
                        ...
                        "onnxruntime_use_cuda": LaunchConfiguration(
                            "onnxruntime_use_cuda"
                        ),
                        "onnxruntime_device_id": LaunchConfiguration(
                            "onnxruntime_device_id"
                        ),
                        "onnxruntime_use_parallel": LaunchConfiguration(
                            "onnxruntime_use_parallel"
                        ),
                        "onnxruntime_inter_op_num_threads": LaunchConfiguration(
                            "onnxruntime_inter_op_num_threads"
                        ),
                        "onnxruntime_intra_op_num_threads": LaunchConfiguration(
                            "onnxruntime_intra_op_num_threads"
                        ),
                        "conf": LaunchConfiguration("conf"),
                        "nms": LaunchConfiguration("nms"),
                        "imshow_isshow": LaunchConfiguration("imshow_isshow"),
                        "src_image_topic_name": LaunchConfiguration(
                            "src_image_topic_name"
                        ),
                        "publish_image_topic_name": LaunchConfiguration(
                            "publish_image_topic_name"
                        ),
                        "publish_boundingbox_topic_name": LaunchConfiguration(
                            "publish_boundingbox_topic_name"
                        ),
                        "publish_resized_image": LaunchConfiguration(
                            "publish_resized_image"
                        ),
