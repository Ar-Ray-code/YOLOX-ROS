...
def generate_launch_description():
    launch_args = [
        ...
        DeclareLaunchArgument(
            "conf", default_value="0.7", description="yolox confidence threshold."
        ),
        DeclareLaunchArgument(
            "nms", default_value="0.45", description="yolox nms threshold"
        ),
        DeclareLaunchArgument("imshow_isshow", default_value="false", description=""),
        DeclareLaunchArgument(
    ...
    (SetEnvironmentVariable(name="RCLCPP_EXECUTOR_THREAD_COUNT", value="2"),)
